...
// Display info message
 if(status == "timeout") {
    $('#onomap_alert').remove();	
    $('#map').append('<div id="onomap_alert" class="alert"> <span class="closebtn" onclick="this.parentElement.style.display=\'none\';">&times;</span>  <strong>Notice</strong><br/>We apologize, the NoiseCapture server is currently not accessible, please come back later, thank you.</div>');
 }
}
